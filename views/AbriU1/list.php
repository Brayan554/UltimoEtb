...
<head>
  ...
  <title>TAR URBA ENERO 04 AL 18</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA ABRIL 05 AL 16</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($AbriU1s as $AbriU1) : ?>
            <tr>
                <td><?php echo $AbriU1->idRemedy?></td>
                <td><?php echo $AbriU1->NOMBREPREDIO?></td>
                <td><?php echo $AbriU1->NEMONICOEQUIPO?></td>
                <td><?php echo $AbriU1->TIPODEINSLACION?></td>
                <td><?php echo $AbriU1->fecha?></td>
                <td><?php echo $AbriU1->LIDERGRUPO?></td>
                
                <td><?php echo $AbriU1->DIRECCIONPREDIO?></td>
                <td>
