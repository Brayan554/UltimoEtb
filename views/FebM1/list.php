...
<head>
  ...
  <title>TAR MSAN FEBRERO 01 AL 12</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR MSAN FEBRERO 01 AL 12  </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($FebM1s as $FebM1) : ?>
            <tr>
                <td><?php echo $FebM1->idRemedy?></td>
                <td><?php echo $FebM1->NOMBREPREDIO?></td>
                <td><?php echo $FebM1->NEMONICOEQUIPO?></td>
                <td><?php echo $FebM1->DIRECCIONPREDIO?></td>
                <td><?php echo $FebM1->TIPODEINSLACION?></td>
                <td><?php echo $FebM1->fecha?></td>
                <td>
