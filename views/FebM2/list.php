...
<head>
  ...
  <title>TAR MSAN FEBRERO 15 AL 26</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR MSAN FEBRERO 15 AL 26  </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($FebM2s as $FebM2) : ?>
            <tr>
                <td><?php echo $FebM2->idRemedy?></td>
                <td><?php echo $FebM2->NOMBREPREDIO?></td>
                <td><?php echo $FebM2->NEMONICOEQUIPO?></td>
                <td><?php echo $FebM2->DIRECCIONPREDIO?></td>
                <td><?php echo $FebM2->TIPODEINSLACION?></td>
                <td><?php echo $FebM2->fecha?></td>
                <td>
