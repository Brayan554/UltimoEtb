...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA MARZO 16 AL 31 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($MarU2s  as $MarU2 ) : ?>
            <tr>
                <td><?php echo $MarU2->idRemedy?></td>
                <td><?php echo $MarU2->NOMBREPREDIO?></td>
                <td><?php echo $MarU2->NEMONICOEQUIPO?></td>
                <td><?php echo $MarU2->TIPODEINSLACION?></td>
                <td><?php echo $MarU2->fecha?></td>
                <td><?php echo $MarU2->LIDERGRUPO?></td>
                
                <td><?php echo $MarU2->DIRECCIONPREDIO?></td>
                <td>
