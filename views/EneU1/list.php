...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA ENERO 04 AL 18 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($EneU1s as $EneU1) : ?>
            <tr>
                <td><?php echo $EneU1->idRemedy?></td>
                <td><?php echo $EneU1->NOMBREPREDIO?></td>
                <td><?php echo $EneU1->NEMONICOEQUIPO?></td>
                <td><?php echo $EneU1->TIPODEINSLACION?></td>
                <td><?php echo $EneU1->fecha?></td>
                <td><?php echo $EneU1->LIDERGRUPO?></td>
                
                <td><?php echo $EneU1->DIRECCIONPREDIO?></td>
                <td>
