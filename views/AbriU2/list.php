...
<head>
  ...
  <title>TAR URBA ABRIL 19 AL 30</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA ABRIL 19 AL 30</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($AbriU2s as $AbriU2) : ?>
            <tr>
                <td><?php echo $AbriU2->idRemedy?></td>
                <td><?php echo $AbriU2->NOMBREPREDIO?></td>
                <td><?php echo $AbriU2->NEMONICOEQUIPO?></td>
                <td><?php echo $AbriU2->TIPODEINSLACION?></td>
                <td><?php echo $AbriU2->fecha?></td>
                <td><?php echo $AbriU2->LIDERGRUPO?></td>
                
                <td><?php echo $AbriU2->DIRECCIONPREDIO?></td>
                <td>
