...
<head>
  ...
  <title>TAR URBA ENERO 19 AL 29</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA ENERO 19 AL 29 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($EneU2s as $EneU2) : ?>
            <tr>
                <td><?php echo $EneU2->idRemedy?></td>
                <td><?php echo $EneU2->NOMBREPREDIO?></td>
                <td><?php echo $EneU2->NEMONICOEQUIPO?></td>
                <td><?php echo $EneU2->TIPODEINSLACION?></td>
                <td><?php echo $EneU2->fecha?></td>
                <td><?php echo $EneU2->LIDERGRUPO?></td>
                
                <td><?php echo $EneU2->DIRECCIONPREDIO?></td>
                <td>
