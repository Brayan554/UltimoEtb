    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $statu->idEstado?></td>
                <td><?php echo $statu->nombreEstado?></td>
                <td>


                  <a type="button" data-toggle="modal"  data-target="#exampleModal<?php echo $statu->idEstado?>" href="?controller=estado&method=edit&idEstado=<?php
                  echo $statu->idEstado?>" class="btn btn-primary"><i class="far fa-edit"></i></a>
                  
                  <a href="?controller=estado&method=delete&idEstado=
                      <?php echo $statu->idEstado?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
