...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA FEBRERO 15 AL 26 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($FebU2s as $FebU2) : ?>
            <tr>
                <td><?php echo $FebU2->idRemedy?></td>
                <td><?php echo $FebU2->NOMBREPREDIO?></td>
                <td><?php echo $FebU2->NEMONICOEQUIPO?></td>
                <td><?php echo $FebU2->TIPODEINSLACION?></td>
                <td><?php echo $FebU2->fecha?></td>
                <td><?php echo $FebU2->LIDERGRUPO?></td>
                
                <td><?php echo $FebU2->DIRECCIONPREDIO?></td>
                <td>
