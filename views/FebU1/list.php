...
<head>
  ...
  <title>TAR URBA FEBRERO 01 AL 12</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TAR URBA FEBRERO 01 AL 12 </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tbody>
            <?php foreach ($FebU1s as $FebU1) : ?>
            <tr>
                <td><?php echo $FebU1->idRemedy?></td>
                <td><?php echo $FebU1->NOMBREPREDIO?></td>
                <td><?php echo $FebU1->NEMONICOEQUIPO?></td>
                <td><?php echo $FebU1->TIPODEINSLACION?></td>
                <td><?php echo $FebU1->fecha?></td>
                <td><?php echo $FebU1->LIDERGRUPO?></td>
                
                <td><?php echo $FebU1->DIRECCIONPREDIO?></td>
                <td>
